...
$message.="<p style='margin-top:5px;font-family:sans-serif;'><strong>Subject:</strong>$subject</p>";
$message.="<p style='margin-top:20px;font-family:sans-serif;'><strong>Message:</strong>$msg</p>";
...
$sent=mail("$admin", "New Enquiry", "$message", implode("\r\n", $headers), "-fuser@pure-marketing.co.uk");
if($sent){
